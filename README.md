...
Digital Banking Simulation: Virtual debit/credit cards, account balances, and currency handling.

Technologies Used

Programming Language: C++

Concepts: OOP, Classes & Objects, File Handling, Data Structures

How to Run

Clone the repository:

git clone [https://github.com/Amir-Moavia/Banking-Management-System/](https://github.com/Amir-Moavia/Banking-Managment-System)
